...
prihlasovacia obrazovka (login screen), pole na meno/heslo, výber používateľa
...
1. TTY nemá grafické rozhranie (iba text)
2. grafický terminál beží v GUI a podporuje myš/okná
